...
(function () {
    ...
    function resetWhatIf() {
        ...
        refreshSliders();
        if (window.setWhatIfSummary)
            window.setWhatIfSummary(null);
        if (window.render)
            window.render();
    }
    ...
    function updateSliderVisual(baseId) {
        ...
        if (!base || !overlay || !deltaBar || !label)
            return;
        const valueEl = label.querySelector(".whatif-val__value");
        const deltaEl = label.querySelector(".whatif-val__delta");
        const min = parseFloat((_b = (_a = base.min) !== null && _a !== void 0 ? _a : overlay.min) !== null && _b !== void 0 ? _b : "0");
        const max = parseFloat((_d = (_c = base.max) !== null && _c !== void 0 ? _c : overlay.max) !== null && _d !== void 0 ? _d : "1");
    ...
    sliders.forEach(slider => {
        if (slider.id === "model_order")
            return;
        if (slider.dataset.whatifReady)
            return;
